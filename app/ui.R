    ...
    sidebarPanel(
      ...
      bsCollapse(
        ...
        bsCollapsePanel(
          ...
          tags$p("For demonstration purposes, the tool returns risk scores as of April 6th, 2022.", class = "text-warning"),
    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Score",
                 ...
                 fluidRow(column(width = 8, withSpinner(gaugeOutput("gauge", height = 'auto'), type = 1))),
