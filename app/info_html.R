...
disclaimerpopupHTML <- function(){
  tagList(
    ...
    tags$p("COVID data behind this app is updated daily - last updated:", format(Sys.Date()-1, "%b %d, %Y"), class = "text-warning"),
    tags$p("Our algorithm is updated periodically - last updated: Oct 30, 2020", class = "text-warning")
  )
}
  ...
  tagList(
    ...
    tags$ol(
      ...
      tags$li("Estimations of risk factors associated with sex and underlying medical conditions were obtained from",
              ...
              tags$a("OpenSAFELY. ", href = urls$open_safely), "Mutually adjusted odds ratios for hospitalization risk and mortality risk", 
              ...
              tags$ul(tags$li("To calculate hospitalization risk, we use mutually adjusted odds ratios from ",  
                      ...
                      tags$li("To calculate ICU risk, we calculate conditional probability of ICU given hospitalization for different comorbidities using data from ",
                              tags$a("CDC MMWR (2020b).", href = urls$cdc_mm6913e2),
                              " and multiply it with the estimated hospitalization risk ",
                              "If multiple comorbidities are reported, we take the highest conditional probability. ",
                              "If no comorbidity is reported, we take the conditional probability for no chronic conditions."),
                      tags$li("To calculate mortality risk, we use mutually adjusted odds ratios from ",
