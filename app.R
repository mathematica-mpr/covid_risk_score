  ...
  output$methods <-renderUI({
    tagList(
      ...
      tags$li(
        ...
        tags$a("Verity et al (2020).", href = "https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(20)30243-7/fulltext"),
      ...
      tags$li("Estimations of risk factors associated with underlying medical conditions were obtained from",
        tags$a("China CDC weekly, 2020 Vol No.2", href = "https://www.unboundmedicine.com/medline/citation/32064853/[The_epidemiological_characteristics_of_an_outbreak_of_2019_novel_coronavirus_diseases__COVID_19__in_China]_"),
