...
write_csv(usafacts_df, here::here("exposure/data/usafacts.csv"))
```
...
```{r}
usafacts_df <- read_csv(here::here("exposure/data/usafacts.csv"))
...
state_CFR_priors <- read.csv(here::here("exposure/data/state_CFR_priors.csv"))
