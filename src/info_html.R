...
renderMethodsHtml <- function() {
  ...
  tagList(
    ...
    tags$ol(
      ...
      tags$li("Estimations for risk adjustment based on gender are from this preprint by", 
      ...
      tags$li("Estimations of risk factors associated with underlying medical conditions were obtained from",
              ...
              tags$ul(tags$li("To adjust hospitalization risk, we use mutually adjusted odds ratios from Killerby et al. ",
                              "This paper does not report odds ratios for 'immunocompromised condition' or ", 
                              "'other chronic disease', so for these two categories we use unadjusted odds ratios from CDCC ",
                      ...
                      tags$li("To adjust for ICU risk, we use unadjusted odds ratios from CDCC (for all but obesity). ",
                              ...
                              "To adjust for obesity, we use the mutually adjusted odds ratio from Simonnet et al."),
                      tags$li("To adjust death risk, we use mutually adjusted odds ratios from OpenSafely. ",
                              "This paper does not report odds ratios for ", 
                              "'other chronic disease', so for this one categoriy we use the unadjusted odds ratio from CDCC ",
